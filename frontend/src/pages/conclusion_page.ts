...
import { setupConclusion } from '../conclusion';

export function renderConclusion(): string {
    ...
    <div class="guide-align">
        <!-- 左側導覽列 -->
        <div id="sidetime" class="brown-left" style="padding: 5px;"></div>
...
function setupSidebarToggle() {
  ...
  export function setupConclusionPage() {
    setupSidebarToggle();
    setupConclusion(); 
